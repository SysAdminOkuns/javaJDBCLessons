    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            myConn = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/demo", "student", "pass123!");
            ...
            myRs = databaseMetaData.getColumns(catalog, schemaPattern,
                    "employees", columnNamePattern);
